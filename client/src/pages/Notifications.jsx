  ...
  return (
    <div className={`min-h-screen transition-colors duration-300 ${
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className={`absolute -top-40 -right-40 h-80 w-80 rounded-full blur-[100px] ${
          darkMode ? "bg-blue-500/10" : "bg-blue-400/20"
        }`} />
        <div className={`absolute -bottom-40 -left-40 h-80 w-80 rounded-full blur-[100px] ${
          ...
          {notifications.length === 0 ? (
            <div className="p-12 sm:p-16 text-center">
              <div className={`inline-flex items-center justify-center w-20 h-20 rounded-full mb-4 ${
                ...
                <svg className={`w-10 h-10 ${darkMode ? "text-slate-600" : "text-slate-400"}`} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1.5">
                  <path strokeLinecap="round" strokeLinejoin="round" d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                </svg>
              </div>
