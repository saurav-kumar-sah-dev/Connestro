...
const styles = {
  page: "container mx-auto px-2 sm:px-4 md:px-6 py-4 md:py-6 transition-colors duration-300",

  shell:
    "min-h-[calc(100dvh-8rem)] flex rounded-2xl overflow-hidden shadow-2xl transition-all duration-300 border-2",
  shellLight: "bg-white border-gray-200",
  shellDark: "bg-gray-900 border-gray-800",

  sidebar: "w-full md:w-[360px] lg:w-[400px] xl:w-[420px] border-r transition-colors duration-300",
  ...
  chat: "flex-1 min-w-0 transition-colors duration-300",
  chatLight: "bg-white",
  chatDark: "bg-gray-900",

  placeholder: "hidden md:flex flex-1 items-center justify-center px-6 text-center",
